          ...
          <div className="experience_wrapper">
            ...
            <ul>
              ...
              <div className="left_andar">
                <ol>
                    ...
                    <li><p>Implemented Brain Cut model to ensure that all the brain tissues in MRI image are intact and not removed as a part of the deidentification process.This model can help researchers evaluate the image since deskulling can remove important voxels from the brain image.</p></li>
                    <li><p>Training data is generated by processing collected T1-weighted images using the BET and BSE tool and surveyed the data in our research group to label it for classification.Pre-processing steps were done to make sure the scaling and sizing of each image is same.</p></li>
                    <li><p>Predicted images that had presence of face tissue or brain tissue with 92 percent of accuracy, providing researcher not only an investigative insight into the MRI image but also saving a lot of time going through all the images present in the study without worrying the identification issues of the patient.</p></li>
                </ol>
              </div>
              <br></br>
            ...
            <div className="left1_andar">
              ...
              <ol>
                ...
                <li><p>Administered everyday operations of website and made necessary changes on a regular basis. Suggested modifications to the researchers to enhance the usability of the website. Performed periodic assessments on website traffic to generate reports on traffic activities.</p></li>
              </ol>
            </div>
            </ul>
            </div>
